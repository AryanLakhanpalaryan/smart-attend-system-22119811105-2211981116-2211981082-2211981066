...
const Signup = () => {
  ...
  const toggleOne = () => {
    ...
    if (fourth) fourth.style.display = "none";
  };
  ...
  const toggleTwo = async () => {
    ...
    if (name.length === 0 || email.length === 0) {
      ...
      // Skip OTP step: go directly to additional details
      const first = document.querySelector(".first-slide");
      const third = document.querySelector(".third-slide");
      const fourth = document.querySelector(".fourth-slide");
  ...
  const toggleFour = () => {
    ...
    if (pno.length === 0 || dob.length === 0) {
      ...
      if (first) first.style.display = "none";
      if (third) third.style.display = "none";
      if (fourth) fourth.style.display = "block";
    }
  };
