...
const assets = [
  {
    ...
    title: "Signup",
    caption:
      "Users have to sign up as either a teacher or a student. After signing up, new users can set their passwords and proceed to their dashboard.",
  },
  {
    image_url: login,
    title: "Login",
  ...
  },
  {
    ...
    caption:
      "Users can reset their passwords by clicking on the 'Forgot Password' link on the login page and then set a new password.",
  },
];
